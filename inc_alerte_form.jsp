...
<select name="typeAlerte" value="<c:out value="${alerte.type}"/>" size="1">
	<option>Dégradation
	<option>Tag
	<option>Usure
</select>
...
<label for="imageAlerte">Image <span class="requis">*</span></label><input type="file" id="imageAlerte" name="imageAlerte" value="<c:out value="${alerte.image}"/>" size="30" maxlength="30" />
<span class="erreur">${form.erreurs['imageAlerte']}</span>
<br />


<label for="prioriteAlerte">Priorité <span class="requis">*</span></label>
<select name="prioriteAlerte" value="<c:out value="${alerte.priorite}"/>" size="1">
	<option>Faible
	<option>Moyenne
	<option>Haute
</select>
...
<input type="text" id="commentaireAlerte" name="commentaireAlerte" value="<c:out value="${alerte.commentaire}"/>" size="75" maxlength="400" />
